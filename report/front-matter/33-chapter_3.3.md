...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Como operador técnico, quiero que el sistema genere alertas automáticas cuando detecte valores críticos para actuar oportunamente.</td>
      <td>5</td>
    </tr>
    <tr>
      <td>6</td>
      ...
      <td>Como operador técnico, quiero identificar cuando el agua cumple parámetros adecuados para su reutilización.</td>
      <td>8</td>
    </tr>
    <tr>
      <td>7</td>
    ...
    <tr>
      ...
      <td>Como operador técnico, quiero que las alertas se clasifiquen según su nivel de riesgo para priorizar la atención.</td>
      <td>3</td>
    </tr>
    <tr>
      <td>13</td>
    ...
    <tr>
      ...
      <td>Como operador técnico, quiero validar que el agua cumpla condiciones específicas antes de su reutilización.</td>
      <td>5</td>
    </tr>
    <tr>
      <td>17</td>
    ...
    <tr>
      <td>18</td>
      <td>US29</td>
      <td>Asignación de agua reutilizada a procesos</td>
    ...
    <tr>
      ...
      <td>Como supervisor, quiero visualizar el impacto del uso de agua reutilizada para evaluar beneficios operativos y ambientales.</td>
      <td>5</td>
    </tr>
    <tr>
      <td>21</td>
    ...
    <tr>
      ...
      <td>Como operador técnico, quiero consultar los datos de monitoreo por zona para identificar áreas con mayor riesgo.</td>
      <td>5</td>
    </tr>
    <tr>
      <td>24</td>
      ...
      <td>Como operador técnico, quiero detectar variaciones anómalas para actuar antes de que ocurra una falla.</td>
      <td>5</td>
    </tr>
    <tr>
      <td>25</td>
      ...
      <td>Como operador técnico, quiero que los datos se actualicen automáticamente para mantener información vigente.</td>
      <td>2</td>
    </tr>
    <tr>
      <td>26</td>
      ...
      <td>Como operador técnico, quiero revisar el historial reciente de los sensores para comparar cambios en la red.</td>
      <td>5</td>
    </tr>
    <tr>
      <td>27</td>
      ...
      <td>Como supervisor, quiero acceder al historial de alertas para analizar incidentes previos.</td>
      <td>3</td>
    </tr>
    <tr>
      <td>28</td>
      ...
      <td>Como operador técnico, quiero marcar alertas como atendidas para llevar control sobre las incidencias resueltas.</td>
      <td>2</td>
    </tr>
    <tr>
      <td>29</td>
    ...
    <tr>
      ...
      <td>Como supervisor, quiero registrar y consultar las intervenciones realizadas para evaluar la efectividad.</td>
      <td>3</td>
    </tr>
    <tr>
      <td>31</td>
    ...
    <tr>
      ...
      <td>Como supervisor, quiero analizar tendencias en los datos para identificar patrones de comportamiento.</td>
      <td>8</td>
    </tr>
    <tr>
      <td>34</td>
      ...
      <td>Como supervisor, quiero consultar reportes de incidencias para evaluar la frecuencia de eventos críticos.</td>
      <td>5</td>
    </tr>
    <tr>
      <td>35</td>
      ...
      <td>Como operador técnico, quiero definir la frecuencia de captura de datos de los sensores.</td>
      <td>3</td>
    </tr>
    <tr>
      <td>36</td>
      ...
      <td>Como usuario, quiero personalizar la visualización del dashboard para priorizar información relevante.</td>
      <td>5</td>
    </tr>
    <tr>
      <td>37</td>
